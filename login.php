...
<body 
style="background: url(images/777.gif);background-size: 40%">
 
<h1 class="alert alert-success rounded-0"><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by:DEVANSHU KUMAR</kbd></small></h1>

<h1>Welcome to FUSION BANK</large></h1>
<br>
<?php echo $error ?>
<br>
