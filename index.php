...
<body style="background:url(images/99.gif);background-size: 40%">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item ">  <a class="nav-link" href="accounts.php">Accounts</a></li>
       <li class="nav-item ">  <a class="nav-link" href="accounts.php">Account Balance</a></li>
...
<div class="row w-100" >
  ...
  <h4 class="display-5">WELCOME TO FUSION BANK</h4>
...
<div class="col">
    <div class="row" style="padding: 22px;padding-top: 0">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/transfer.gif" alt="Card image cap" style="max-height: 155px;min-height: 155px">
        <div class="card-body">
    ...
    <div class="row" style="padding: 22px">
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/notification.gif" style="max-height: 155px;min-height: 155px" alt="Card image cap">
          <div class="card-body">
